...
class GetRecordsStatisticsUseCase implements UseCase<Either, StatisticRequest> {
  final AuthRepository authRepository;

  GetRecordsStatisticsUseCase({required this.authRepository});
  ...
  Future<Either> call(StatisticRequest request) async {
    ...
    return await sl<StatisticRepository>().getRecordsStatistics(request, token);
  }
}
