...
class PatientInfoReceptionistView extends StatefulWidget {
  final int patientId;
  final String patientName;

  const PatientInfoReceptionistView({
    super.key,
  ...
  @override
  State<PatientInfoReceptionistView> createState() =>
      _PatientInfoReceptionistViewState();
}

class _PatientInfoReceptionistViewState
    extends State<PatientInfoReceptionistView> {
  ...
  @override
  void didUpdateWidget(PatientInfoReceptionistView oldWidget) {
